...
type VesselService interface {
	FindFree(ctx context.Context, in *Specification, opts ...client.CallOption) (*Response, error)
}
...
func (c *vesselService) FindFree(ctx context.Context, in *Specification, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "VesselService.FindFree", in)
	out := new(Response)
...
type VesselServiceHandler interface {
	FindFree(context.Context, *Specification, *Response) error
}

func RegisterVesselServiceHandler(s server.Server, hdlr VesselServiceHandler, opts ...server.HandlerOption) error {
	type vesselService interface {
		FindFree(ctx context.Context, in *Specification, out *Response) error
	}
	type VesselService struct {
		vesselService
	}
...
func (h *vesselServiceHandler) FindFree(ctx context.Context, in *Specification, out *Response) error {
	return h.VesselServiceHandler.FindFree(ctx, in, out)
}
